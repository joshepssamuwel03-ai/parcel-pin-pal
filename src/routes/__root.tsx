...
import { getStoredTheme, setActiveUser } from "../lib/store";
  ...
  head: () => ({
    meta: [
      ...
      { title: "Parcel Customer Location Tracker" },
      {
        name: "description",
        content:
          "Premium delivery app for riders to save customer GPS locations and instantly find repeat customers on a live map.",
      },
